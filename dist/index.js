...
const DrawerConfigContext = React__namespace.default.createContext(undefined);
const useDrawerConfig = ()=>{
    return React__namespace.default.useContext(DrawerConfigContext);
};
...
function ConfigProvider({ children, container, containerId }) {
    const [resolvedContainer, setResolvedContainer] = React__namespace.default.useState(container || null);
    React__namespace.default.useEffect(()=>{
        if (container) {
    ...
    return /*#__PURE__*/ React__namespace.default.createElement(DrawerConfigContext.Provider, {
        value: {
